    ...
    return (
            <footer>
                ...
                <div className="contact_information">
                        ...
                        <Link to="https://api.whatsapp.com/send?phone=+527771430158&text=¡Estoy+interesad%40+en+que+me+informen+de+su+universidad%21+👋😀" className="social"><img src={`${endointLocal}img/whatsapp.png`} alt="Whatsapp de Universidad Monte Albán" className = "icon_social_header"/>Whatsapp</Link>
